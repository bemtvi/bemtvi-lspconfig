...
- `filetypes`:
  ...
  { "ada" }
  ```
- `root_dir`: [../lsp/ada_ls.lua:26](../lsp/ada_ls.lua#L26)
...
- `filetypes`:
  ...
  { "agda" }
  ```
- `root_dir`: [../lsp/agda_ls.lua:12](../lsp/agda_ls.lua#L12)
...
Default config:
- `cmd`: [../lsp/apex_ls.lua:38](../lsp/apex_ls.lua#L38)
- `filetypes`:
  ```lua
  { "apex", "apexcode" }
  ```
...
- `filetypes`:
  ...
  { "arduino" }
  ```
- `root_dir`: [../lsp/arduino_language_server.lua:75](../lsp/arduino_language_server.lua#L75)
...
- `filetypes`:
  ...
  ```
- `reuse_client`: [../lsp/ast_grep.lua:14](../lsp/ast_grep.lua#L14)
- `root_markers`:
  ```lua
...
Default config:
- `before_init`: [../lsp/astro.lua:88](../lsp/astro.lua#L88)
...
Default config:
- `before_init`: [../lsp/autohotkey_lsp.lua:25](../lsp/autohotkey_lsp.lua#L25)
- `cmd`:
  ```lua
...
- `init_options`:
  ```lua
  {
    ...
    Diagnostics = { ClassStaticMemberCheck = true, ParamsCheck = true },
    FormatOptions = {
      array_style = "expand",
...
- `filetypes`:
  ...
  ```
- `root_dir`: [../lsp/autotools_ls.lua:19](../lsp/autotools_ls.lua#L19)
...
- `filetypes`:
  ...
  { "python" }
  ```
- `on_attach`: [../lsp/basedpyright.lua:56](../lsp/basedpyright.lua#L56)
- `root_markers`:
  ```lua
  {
    "pyrightconfig.json",
...
- `filetypes`:
  ...
  ```
- `root_dir`: [../lsp/biome.lua:33](../lsp/biome.lua#L33)
- `workspace_required`:
  ```lua
  true
  ```
...
- `filetypes`:
  ...
  { "proto", "buf-config" }
  ```
- `reuse_client`: [../lsp/buf_ls.lua:25](../lsp/buf_ls.lua#L25)
- `root_markers`:
  ```lua
  { "buf.yaml", ".git" }
  ```
...
- `offset_encoding`:
  ...
  "utf-32"
  ```
- `on_attach`: [../lsp/ccls.lua:51](../lsp/ccls.lua#L51)
- `root_markers`:
  ```lua
...
- `filetypes`:
  ...
  ```
- `get_language_id`: [../lsp/clangd.lua:79](../lsp/clangd.lua#L79)
- `on_attach`: [../lsp/clangd.lua:97](../lsp/clangd.lua#L97)
- `on_init`: [../lsp/clangd.lua:92](../lsp/clangd.lua#L92)
- `root_markers`:
  ```lua
  {
    ".clangd",
...
- `filetypes`:
  ...
  { "cs" }
  ```
- `get_language_id`: [../lsp/csharp_ls.lua:26](../lsp/csharp_ls.lua#L26)
- `init_options`:
  ```lua
  { AutomaticWorkspaceInit = true }
  ```
- `root_dir`: [../lsp/csharp_ls.lua:17](../lsp/csharp_ls.lua#L17)
...
- `filetypes`:
  ...
  { "css", "scss", "less" }
  ```
- `root_dir`: [../lsp/css_variables.lua:20](../lsp/css_variables.lua#L20)
- `settings`:
  ```lua
  {
    cssVariables = {
...
Default config:
- `cmd`: [../lsp/cssls.lua:29](../lsp/cssls.lua#L29)
- `filetypes`:
  ```lua
  { "css", "scss", "less" }
  ```
...
- `filetypes`:
  ...
  ```
- `on_attach`: [../lsp/denols.lua:102](../lsp/denols.lua#L102)
- `root_dir`: [../lsp/denols.lua:71](../lsp/denols.lua#L71)
- `settings`:
  ```lua
  {
    deno = {
...
- `filetypes`:
  ...
  ```
- `get_language_id`: [../lsp/docker_language_server.lua:13](../lsp/docker_language_server.lua#L13)
- `root_markers`:
  ```lua
  {
    "Dockerfile",
...
- `init_options`:
  ...
  ```
- `on_attach`: [../lsp/ds_pinyin_lsp.lua:63](../lsp/ds_pinyin_lsp.lua#L63)
- `root_markers`:
  ```lua
  { ".git" }
  ```
...
- `filetypes`:
  ...
  ```
- `root_dir`: [../lsp/elixirls.lua:38](../lsp/elixirls.lua#L38)
...
- `init_options`:
  ...
  ```
- `root_dir`: [../lsp/elmls.lua:16](../lsp/elmls.lua#L16)
...
- `settings`:
  ```lua
  {
    emmylua = { codeLens = { enable = true }, hint = { enable = true } },
  }
  ```
- `workspace_required`:
  ```lua
...
Default config:
- `before_init`: [../lsp/eslint.lua:180](../lsp/eslint.lua#L180)
- `cmd`: [../lsp/eslint.lua:78](../lsp/eslint.lua#L78)
- `filetypes`:
  ```lua
  {
    "javascript",
...
- `handlers`:
  ...
  ```
- `on_attach`: [../lsp/eslint.lua:90](../lsp/eslint.lua#L90)
- `root_dir`: [../lsp/eslint.lua:106](../lsp/eslint.lua#L106)
- `settings`:
  ```lua
  {
    codeAction = {
...
- `filetypes`:
  ...
  { "elixir", "eelixir", "heex", "surface" }
  ```
- `root_dir`: [../lsp/expert.lua:17](../lsp/expert.lua#L17)
...
Default config:
- `cmd`: [../lsp/fallow.lua:10](../lsp/fallow.lua#L10)
- `filetypes`:
  ```lua
  {
    "javascript",
...
Default config:
- `cmd`: [../lsp/flow.lua:18](../lsp/flow.lua#L18)
- `filetypes`:
  ```lua
...
- `filetypes`:
  ...
  { "foam", "OpenFOAM" }
  ```
- `root_dir`: [../lsp/foam_ls.lua:19](../lsp/foam_ls.lua#L19)
...
- `init_options`:
  ...
  { AutomaticWorkspaceInit = true }
  ```
- `root_dir`: [../lsp/fsautocomplete.lua:24](../lsp/fsautocomplete.lua#L24)
- `settings`:
  ```lua
  {
    FSharp = {
...
Default config:
- `cmd`: [../lsp/gdscript.lua:17](../lsp/gdscript.lua#L17)
- `filetypes`:
  ```lua
  { "gdscript" }
  ```
...
- `init_options`:
  ...
  ```
- `root_dir`: [../lsp/gitlab_ci_ls.lua:17](../lsp/gitlab_ci_ls.lua#L17)
...
- `on_init`: [../lsp/gitlab_duo.lua:340](../lsp/gitlab_duo.lua#L340)
- `root_markers`:
  ```lua
  { ".git" }
  ```
- `settings`:
  ```lua
  {
    ...
    codeCompletion = { enableSecretRedaction = true },
    featureFlags = { streamCodeGenerations = false },
    logLevel = "info",
...
Default config:
- `cmd`: [../lsp/glint.lua:28](../lsp/glint.lua#L28)
- `filetypes`:
  ```lua
  {
    "html.handlebars",
...
Default config:
- `before_init`: [../lsp/golangci_lint_ls.lua:48](../lsp/golangci_lint_ls.lua#L48)
- `cmd`:
  ```lua
...
- `filetypes`:
  ...
  ```
- `root_dir`: [../lsp/gopls.lua:92](../lsp/gopls.lua#L92)
- `settings`:
  ```lua
...
- `filetypes`:
  ...
  ```
- `root_dir`: [../lsp/graphql.lua:18](../lsp/graphql.lua#L18)
...
- `filetypes`:
  ...
  { "haskell", "lhaskell" }
  ```
- `root_dir`: [../lsp/hls.lua:20](../lsp/hls.lua#L20)
- `settings`:
  ```lua
  {
    haskell = {
...
Default config:
- `cmd`: [../lsp/html.lua:30](../lsp/html.lua#L30)
- `filetypes`:
  ```lua
  { "html" }
  ```
...
- `filetypes`:
  ...
  { "idris2" }
  ```
- `root_dir`: [../lsp/idris2_lsp.lua:37](../lsp/idris2_lsp.lua#L37)
...
Default config:
- `cmd`: [../lsp/jsonls.lua:30](../lsp/jsonls.lua#L30)
- `filetypes`:
  ```lua
  { "json", "jsonc" }
  ```
...
- `filetypes`:
  ...
  { "julia" }
  ```
- `on_attach`: [../lsp/julials.lua:142](../lsp/julials.lua#L142)
- `root_markers`:
  ```lua
...
Default config:
- `before_init`: [../lsp/kotlin_language_server.lua:42](../lsp/kotlin_language_server.lua#L42)
- `cmd`:
  ```lua
...
- `offset_encoding`:
  ...
  "utf-32"
  ```
- `root_dir`: [../lsp/lean3ls.lua:23](../lsp/lean3ls.lua#L23)
...
- `filetypes`:
  ...
  ```
- `get_language_id`: [../lsp/ltex.lua:80](../lsp/ltex.lua#L80)
- `root_markers`:
  ```lua
  { ".git" }
  ```
...
- `filetypes`:
  ...
  ```
- `get_language_id`: [../lsp/ltex_plus.lua:61](../lsp/ltex_plus.lua#L61)
- `root_markers`:
  ```lua
  { ".git" }
  ```
...
- `filetypes`:
  ...
  { "markdown" }
  ```
- `on_attach`: [../lsp/markdown_oxide.lua:29](../lsp/markdown_oxide.lua#L29)
- `root_markers`:
  ```lua
...
- `filetypes`:
  ...
  { "matlab" }
  ```
- `root_dir`: [../lsp/matlab_ls.lua:23](../lsp/matlab_ls.lua#L23)
- `settings`:
  ```lua
  {
    MATLAB = {
...
Default config:
- `before_init`: [../lsp/mdx_analyzer.lua:16](../lsp/mdx_analyzer.lua#L16)
- `cmd`:
  ```lua
...
- `filetypes`:
  ...
  { "meson" }
  ```
- `root_dir`: [../lsp/mesonlsp.lua:35](../lsp/mesonlsp.lua#L35)
...
- `filetypes`:
  ...
  { "markdown" }
  ```
- `on_attach`: [../lsp/mpls.lua:20](../lsp/mpls.lua#L20)
- `root_markers`:
  ```lua
  { ".marksman.toml", ".git" }
  ```
...
- `filetypes`:
  ...
  { "meson" }
  ```
- `root_dir`: [../lsp/muon.lua:10](../lsp/muon.lua#L10)
...
- `filetypes`:
  ...
  { "nim" }
  ```
- `root_dir`: [../lsp/nim_langserver.lua:16](../lsp/nim_langserver.lua#L16)
...
- `filetypes`:
  ...
  { "nim" }
  ```
- `root_dir`: [../lsp/nimls.lua:16](../lsp/nimls.lua#L16)
...
- `filetypes`:
  ...
  { "hcl.nomad", "nomad" }
  ```
- `root_dir`: [../lsp/nomad_lsp.lua:25](../lsp/nomad_lsp.lua#L25)
...
- `filetypes`:
  ...
  { "nu" }
  ```
- `root_dir`: [../lsp/nushell.lua:12](../lsp/nushell.lua#L12)
...
- `filetypes`:
  ...
  ```
- `get_language_id`: [../lsp/ocamllsp.lua:87](../lsp/ocamllsp.lua#L87)
- `on_attach`: [../lsp/ocamllsp.lua:88](../lsp/ocamllsp.lua#L88)
- `root_markers`:
  ```lua
  {
...
- `filetypes`:
  ...
  { "odin" }
  ```
- `root_dir`: [../lsp/ols.lua:12](../lsp/ols.lua#L12)
...
- `capabilities`:
  ...
  ```
- `cmd`: [../lsp/omnisharp.lua:21](../lsp/omnisharp.lua#L21)
- `filetypes`:
  ```lua
  { "cs", "vb" }
  ```
...
- `filetypes`:
  ...
  ```
- `root_dir`: [../lsp/oxfmt.lua:40](../lsp/oxfmt.lua#L40)
- `workspace_required`:
  ```lua
  true
  ```
...
Default config:
- `before_init`: [../lsp/oxlint.lua:91](../lsp/oxlint.lua#L91)
...
- `filetypes`:
  ...
  ```
- `on_attach`: [../lsp/oxlint.lua:71](../lsp/oxlint.lua#L71)
...
- `filetypes`:
  ...
  { "pascal" }
  ```
- `root_dir`: [../lsp/pasls.lua:23](../lsp/pasls.lua#L23)
...
- `filetypes`:
  ...
  { "php" }
  ```
- `root_dir`: [../lsp/phan.lua:25](../lsp/phan.lua#L25)
...
- `init_options`:
  ...
  { ["0"] = "{}" }
  ```
- `root_dir`: [../lsp/phptools.lua:26](../lsp/phptools.lua#L26)
...
- `filetypes`:
  ...
  { "pony" }
  ```
- `on_init`: [../lsp/pony_language_server.lua:9](../lsp/pony_language_server.lua#L9)
- `root_markers`:
  ```lua
  { "corral.json", ".git" }
  ```
...
- `filetypes`:
  ...
  { "python" }
  ```
- `on_exit`: [../lsp/pyrefly.lua:22](../lsp/pyrefly.lua#L22)
- `root_markers`:
  ```lua
  {
    "pyrefly.toml",
...
- `filetypes`:
  ...
  { "python" }
  ```
- `on_attach`: [../lsp/pyright.lua:62](../lsp/pyright.lua#L62)
- `root_markers`:
  ```lua
  {
    "pyrightconfig.json",
...
- `filetypes`:
  ...
  { "r", "rmd", "quarto" }
  ```
- `root_dir`: [../lsp/r_language_server.lua:18](../lsp/r_language_server.lua#L18)
...
- `filetypes`:
  ...
  { "rego" }
  ```
- `root_dir`: [../lsp/regal.lua:17](../lsp/regal.lua#L17)
...
- `filetypes`:
  ...
  { "rego" }
  ```
- `root_dir`: [../lsp/regols.lua:17](../lsp/regols.lua#L17)
...
- `init_options`:
  ```lua
  {
    extensionConfiguration = {
      ...
      codeLens = true,
      incrementalTypechecking = { acrossFiles = true, enable = true },
...
- `filetypes`:
  ...
  { "robot", "resource" }
  ```
- `get_language_id`: [../lsp/robotcode.lua:35](../lsp/robotcode.lua#L35)
- `root_markers`:
  ```lua
...
Default config:
- `cmd`: [../lsp/rome.lua:16](../lsp/rome.lua#L16)
- `filetypes`:
  ```lua
  {
    "javascript",
...
Default config:
- `before_init`: [../lsp/roslyn_ls.lua:184](../lsp/roslyn_ls.lua#L184)
- `capabilities`:
  ```lua
  { textDocument = { diagnostic = { dynamicRegistration = true } } }
  ```
- `cmd`: [../lsp/roslyn_ls.lua:172](../lsp/roslyn_ls.lua#L172)
- `commands`:
  ```lua
  {
...
- `name`:
  ...
  "roslyn_ls"
  ```
- `on_attach`: [../lsp/roslyn_ls.lua:333](../lsp/roslyn_ls.lua#L333)
- `on_init`:
  ```lua
  { <function> }
  ```
- `root_dir`: [../lsp/roslyn_ls.lua:284](../lsp/roslyn_ls.lua#L284)
- `settings`:
  ```lua
  {
...
- `init_options`:
  ...
  { formatter = "auto" }
  ```
- `reuse_client`: [../lsp/ruby_lsp.lua:23](../lsp/ruby_lsp.lua#L23)
- `root_markers`:
  ```lua
  { "Gemfile", ".git" }
  ```
...
- `filetypes`:
  ...
  { "python" }
  ```
- `on_init`: [../lsp/ruff_lsp.lua:31](../lsp/ruff_lsp.lua#L31)
- `root_markers`:
  ```lua
...
Default config:
- `before_init`: [../lsp/rust_analyzer.lua:154](../lsp/rust_analyzer.lua#L154)
- `capabilities`:
  ```lua
  {
    experimental = {
...
- `filetypes`:
  ...
  { "rust" }
  ```
- `on_attach`: [../lsp/rust_analyzer.lua:179](../lsp/rust_analyzer.lua#L179)
...
- `filetypes`:
  ...
  { "solidity" }
  ```
- `root_dir`: [../lsp/solc.lua:12](../lsp/solc.lua#L12)
...
- `filetypes`:
  ...
  ```
- `get_language_id`: [../lsp/sourcekit.lua:30](../lsp/sourcekit.lua#L30)
- `root_dir`: [../lsp/sourcekit.lua:12](../lsp/sourcekit.lua#L12)
...
- `filetypes`:
  ...
  ```
- `on_attach`: [../lsp/stylelint_lsp.lua:68](../lsp/stylelint_lsp.lua#L68)
- `root_dir`: [../lsp/stylelint_lsp.lua:33](../lsp/stylelint_lsp.lua#L33)
- `settings`:
  ```lua
  {
    stylelint = {
...
Default config:
- `cmd`: [../lsp/svelte.lua:15](../lsp/svelte.lua#L15)
- `filetypes`:
  ```lua
  { "svelte" }
  ```
- `on_attach`: [../lsp/svelte.lua:44](../lsp/svelte.lua#L44)
- `root_dir`: [../lsp/svelte.lua:32](../lsp/svelte.lua#L32)
- `settings`:
  ```lua
  {
    typescript = {
...
- `filetypes`:
  ...
  ```
- `on_attach`: [../lsp/svlangserver.lua:24](../lsp/svlangserver.lua#L24)
- `root_markers`:
  ```lua
  { ".svlangserver", ".git" }
  ```
...
- `filetypes`:
  ...
  { "systemd" }
  ```
- `on_init`: [../lsp/systemd_ls.lua:9](../lsp/systemd_ls.lua#L9)
...
Default config:
- `before_init`: [../lsp/tailwindcss.lua:108](../lsp/tailwindcss.lua#L108)
- `capabilities`:
  ```lua
  {
    workspace = { didChangeWatchedFiles = { dynamicRegistration = true } },
...
- `filetypes`:
  ...
  ```
- `root_dir`: [../lsp/tailwindcss.lua:114](../lsp/tailwindcss.lua#L114)
- `settings`:
  ```lua
  {
    tailwindCSS = {
...
Default config:
- `cmd`: [../lsp/tblgen_lsp_server.lua:16](../lsp/tblgen_lsp_server.lua#L16)
- `filetypes`:
  ```lua
  { "tablegen" }
  ```
...
- `cmd`:
  ...
  ```
- `root_dir`: [../lsp/termux_language_server.lua:11](../lsp/termux_language_server.lua#L11)
...
- `filetypes`:
  ...
  { "tex", "plaintex", "bib" }
  ```
- `on_attach`: [../lsp/texlab.lua:165](../lsp/texlab.lua#L165)
- `root_markers`:
  ```lua
  {
    ".git",
...
- `settings`:
  ```lua
  {
    textLSP = {
      analysers = {
        languagetool = {
          check_text = { on_change = false, on_open = true, on_save = true },
          enabled = true,
        },
      },
      documents = {
...
- `filetypes`:
  ...
  { "typst" }
  ```
- `on_attach`: [../lsp/tinymist.lua:50](../lsp/tinymist.lua#L50)
- `root_markers`:
  ```lua
  { ".git" }
  ```
...
Default config:
- `cmd`: [../lsp/ts_ls.lua:89](../lsp/ts_ls.lua#L89)
- `commands`:
  ```lua
  { ["editor.action.showReferences"] = <function> }
  ```
- `filetypes`:
  ```lua
  {
...
- `init_options`:
  ...
  { hostInfo = "neovim" }
  ```
- `on_attach`: [../lsp/ts_ls.lua:152](../lsp/ts_ls.lua#L152)
- `root_dir`: [../lsp/ts_ls.lua:96](../lsp/ts_ls.lua#L96)
...
Default config:
- `cmd`: [../lsp/tsgo.lua:65](../lsp/tsgo.lua#L65)
- `filetypes`:
  ```lua
  {
    "javascript",
  ...
  ```
- `root_dir`: [../lsp/tsgo.lua:72](../lsp/tsgo.lua#L72)
- `settings`:
  ```lua
  {
    typescript = {
...
Default config:
- `cmd`: [../lsp/turtle_ls.lua:20](../lsp/turtle_ls.lua#L20)
- `filetypes`:
  ```lua
  { "turtle", "ttl" }
  ```
...
- `filetypes`:
  ...
  { "vala", "genie" }
  ```
- `root_dir`: [../lsp/vala_ls.lua:32](../lsp/vala_ls.lua#L32)
...
- `filetypes`:
  ...
  { "coq" }
  ```
- `on_init`: [../lsp/vscoqtop.lua:9](../lsp/vscoqtop.lua#L9)
- `root_markers`:
  ```lua
...
- `init_options`:
  ...
  { hostInfo = "neovim" }
  ```
- `root_dir`: [../lsp/vtsls.lua:79](../lsp/vtsls.lua#L79)
...
- `filetypes`:
  ...
  { "vue" }
  ```
- `on_init`: [../lsp/vue_ls.lua:25](../lsp/vue_ls.lua#L25)
- `root_markers`:
  ```lua
  { "package.json" }
  ```
...
Default config:
- `cmd`: [../lsp/yamlls.lua:65](../lsp/yamlls.lua#L65)
- `filetypes`:
  ```lua
  {
    "yaml",
  ...
  ```
- `on_init`: [../lsp/yamlls.lua:74](../lsp/yamlls.lua#L74)
- `root_markers`:
  ```lua
  { ".git" }
  ```
...
- `filetypes`:
  ...
  { "markdown" }
  ```
- `on_attach`: [../lsp/zk.lua:46](../lsp/zk.lua#L46)
- `root_markers`:
  ```lua
  { ".zk" }
  ```
